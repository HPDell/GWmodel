...
bool CGWmodelCUDA::Regression(bool hatmatrix, bool ftest,
	double p, double theta, bool longlat,
	double bw, int kernel, bool adaptive,
	int groupl, int gpuID)
{
	if (hatmatrix && !rp_given)
	{
		mRegressionFunction = ftest ? &CGWmodelCUDA::RegressionWithHatmatrixFtest : &CGWmodelCUDA::RegressionWithHatmatrix;
	}
	else
	{
		mRegressionFunction = &CGWmodelCUDA::RegressionOnly;
	}
	return (this->*mRegressionFunction)(p, theta, longlat, bw, kernel, adaptive, groupl, gpuID);
}

bool CGWmodelCUDA::RegressionWithHatmatrixFtest(double p, double theta, bool longlat, double bw, int kernel, bool adaptive, int groupl, int gpuID)
{
...
bool CGWmodelCUDA::RegressionWithHatmatrix(double p, double theta, bool longlat,double bw, int kernel, bool adaptive, int groupl, int gpuID)
{
	int n = rp.n_rows, N = dp.n_rows, K = x.n_rows;
	// ====================
	// Check GPU properties
...
bool CGWmodelCUDA::RegressionOnly(double p, double theta, bool longlat, double bw, int kernel, bool adaptive, int groupl, int gpuID)
{
	int n = rp.n_rows, N = dp.n_rows, K = x.n_rows;
	// ====================
	// Check GPU properties
